...
SECRET_KEY = '+)lbhkm%#jo7^9gubka_g%!8wxg-uec6s5v5_4bj#71(auv5(j'
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_RENDERER_CLASSES': [
    #     'rest_framework.renderers.JSONRenderer', # for OrderedDict ????
    #     'rest_framework.renderers.BrowsableAPIRenderer',
    # ],

    'DEFAULT_METADATA_CLASS': 'api.core.DemoMetadata',  # for options method
}
...
JWT_AUTH = {
    ...
    # 'users.views.jwt_payload_handler',
    'api.core.jwt_payload_handler',
    ...
    'JWT_EXPIRATION_DELTA': datetime.timedelta(seconds=10000000),
    'JWT_AUDIENCE': None,
    'JWT_ISSUER': None,
